...
url = (
    f"{search_endpoint}/indexes/incident-knowledge-v2/docs/search"
...
search_body = {
    ...
    "filter": "region eq 'India' and isActive eq true",
    "search": "502 error India production",
    "select": "id,content,alertType,severity,region,documentVersion, isActive"
}
